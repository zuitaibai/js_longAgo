...
;(function(window,$){
    ...
    var Z={
        ...
        config:{
            ...
            tabs:{
                attrName:'data-tabs',
                defaultOpt:{tabsSelectStr:'',contentSelectStr:'',activeClass:'',toggleStr:'toggle',eventType:'mouseover',callback:null,initIndex:undefined}
            },
            asSelect:{
                attrName:'data-asselect',
                defaultOpt:{eventType:'click',onChange:null,speed:'0',newClass:'',isReplacedefClass:'false',zIndex:'00',width:'200',forId:undefined,disabled:'false',disabledClass:'asSelectDisabled'}
            },
            china3city:{
                attrName:'data-china3city',
                defaultOpt:{ajax:'false',ajaxUrl:'',provinceSelectStr:'',citySelectStr:'',countrySelectStr:'',useUI:'false',UIAddClass:'',isReplacedefClass:'false',chooseText:'--请选择--'}
            }
        },
        global:{
            asSelect:{
                staticNumber:0
                //object1     metheds:disabled(true||false) val(get||set) addItem(v,t) removeItem(v)
                //  .
                //  .
            }
        },
        tools:{
            attrToOptsObject:function($o,attrStr){
                var str=$.trim($o.attr(attrStr));
    ...
    Z.requirejs.config({
        ...
        paths:{
            tabs:'tabs/tabs',
            asSelect:'asSelect/asSelect',
            china3city:'china3city/china3city'
        },
        shim:{
            asSelect:{
                deps:['css!asSelect.css']
            },
            china3city:{
                deps:['css!china3city.css']
            }
        }
    });

    window['zjf']=window.zjf||Z;
})(window,jQuery);